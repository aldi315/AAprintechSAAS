...
import { RegisterResellerUseCase } from '@/application/use-cases/register-reseller.use-case'
...
export const registerResellerUseCase = new RegisterResellerUseCase(authRepository, passwordService)
